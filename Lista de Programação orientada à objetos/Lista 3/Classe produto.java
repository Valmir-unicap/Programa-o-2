...
public class Produto implements Comparable<Produto>{
    ...
    @Override
    public int compareTo(Produto P){//Permite a comparação do que eu desejar.
        return this.codigo.compareTo(P.codigo);//comparação entre dois codigos
    }
    ...
    public void venderProduto(int estoque){
        ...
        while(quantidade<=0 || quantidade>this.getEstoque()){
            System.out.print("Quantidade insuficiente, digite novamente: ");
            quantidade= in.nextInt();
        }
...
//pra fazer o item 3 deve fazer outro compareTo com getFornecedor//apesar que fornecdor não é um objeto
//em seguida fazer a busca na outra classe
//exbir na outra classe;
