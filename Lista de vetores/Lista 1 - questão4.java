...
public class P2Lista1vetorQ4 {
    public static void main(String[] args) {
        ...
        do{
            ...
            while(pergunta!='s' && pergunta!='n'){
                ...
                pergunta= in.next().charAt(0);    
                pergunta= Character.toLowerCase(pergunta);
            }
        }while(pergunta!='n');
            exibir(voto);
    ...
    public static void percentualVotos(int[] votos){
      int resultado;
     resultado= votos[0]+votos[1]+votos[2]+votos[3]+votos[4]+votos[5]+votos[6]+votos[7]+votos[8]+votos[9];
          System.out.println("A soma geral de votos: "+resultado);
          //falta fazer a porcentagem.
          //melhorar essa soma geral.
    }
}
